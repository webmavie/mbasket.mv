...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'file' => ':attribute boyutu, :value kilobyte değerinden büyük olmalıdır.',
        'string' => ':attribute metni, :value karakterden büyük olmalıdır.',
        'array' => ':attribute değerinin, :value nesneden daha fazlasına sahip olmalıdır.',
    ],
    'gte' => [
        'numeric' => ':attribute değeri, :value değerinden büyük veya eşit olmalıdır.',
        'file' => ':attribute boyutu, :value kilobyte değerinden büyük veya eşit olmalıdır.',
        'string' => ':attribute metni, :value karakterden büyük veya eşit olmalıdır.',
        'array' => ':attribute değerinin, :value veya daha fazla nesneye sahip olmalıdır.',
    ],
    ...
    'lt' => [
        ...
        'file' => ':attribute boyutu :value kilobyte değerinden küçük olmalıdır.',
        'string' => ':attribute metni, :value karakterden küçük olmalıdır.',
        'array' => ':attribute değerinin, :value nesneden daha az olmalıdır.',
    ],
    'lte' => [
        'numeric' => ':attribute değeri, :value değerinden küçük veya eşit olmalıdır.',
        'file' => ':attribute boyutu :value kilobyte değerinden küçük veya eşit olmalıdır.',
        'string' => ':attribute metni, :value karakterden küçük veya eşit olmalıdır.',
        'array' => ':attribute değerinin, :value veya daha az nesneye sahip olmalıdır.',
    ],
    'max' => [
    ...
    'uuid' => ':attribute geçeli bir UUID olmalıdır.',
